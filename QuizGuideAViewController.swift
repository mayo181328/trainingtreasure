...
class QuizGuideAViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    //        ポイント初期化
            ...
            QuizArray = quizBrainFree.GuideMapAList
...
//                    思考力
    ...
    //        正誤判定用ボタン名の生成
            ...
            Button4.setTitle(QuizArray[randomNumber].section1, for: .normal) as? String
            Button5.setTitle(QuizArray[randomNumber].section2, for: .normal) as? String
            Button6.setTitle(QuizArray[randomNumber].section3, for: .normal) as? String
            Button7.setTitle(QuizArray[randomNumber].section1, for: .normal) as? String
