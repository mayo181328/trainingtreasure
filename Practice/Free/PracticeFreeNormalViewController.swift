//
//  PracticeFreeNormalViewController.swift
//  EnglishStudyApp
//
...
class PracticeFreeNormalViewController: UIViewController ,ButtonTapDelegate , AVAudioPlayerDelegate,CancelTapDelegate{
    ...
    @IBAction func dishesButton(_ sender: Any) {
        quizName = "dishes"
        quizType = 3
    ...
    @IBAction func accentButton(_ sender: Any) {
        quizName = "accent"
        quizType = 3
        let soundURL  = Bundle.main.url(forResource: "decision", withExtension: "mp3")
        do{
